...
```{r, echo=FALSE, tidy=TRUE, results='hide'}
...
```{r, varImp, fig.cap="Variable Importance Plot\\label{fig:varimp}", echo=FALSE}
...
```{r, OOBPlot, fig.cap="Out-of-bag (OOB) Error Estimate\\label{fig:oobplot}", echo=FALSE}
